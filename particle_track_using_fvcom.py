...
st_lat=[]
st_lon=[]
latc=np.linspace(41.8,42.0)
lonc=np.linspace(-70.5,-70.2)
...
'''
days=3 # number of days to track
jia=14*0 # always zero
end_times=[]
start_time=[]
start_times=[dt.datetime(2014,11,14,0,0,0,0)]#,dt.datetime(2013,5,1,0,0,0,0),dt.datetime(2012,5,1,0,0,0,0),dt.datetime(2011,5,1,0,0,0,0),dt.datetime(2010,5,1,0,0,0,0),dt.datetime(2009,5,1,0,0,0,0),dt.datetime(2008,5,1,0,0,0,0),dt.datetime(2007,5,1,0,0,0,0)]
###############################################  END of HARDCODES  #########################################
